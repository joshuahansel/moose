...
/**
 * Integrates a heat structure boundary convective heat flux from an external
 * application
 */
class HeatRateExternalAppConvection : public SideIntegralPostprocessor
{
public:
  HeatRateExternalAppConvection(const InputParameters & parameters);

...
/**
 * Base class for ideal gas fluid properties
 */
class IdealGasFluidPropertiesBase : public SinglePhaseFluidProperties, public NaNInterface
{
public:
  static InputParameters validParams();

  IdealGasFluidPropertiesBase(const InputParameters & parameters);
  virtual ~IdealGasFluidPropertiesBase();

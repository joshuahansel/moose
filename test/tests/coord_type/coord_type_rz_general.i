...
#   block2: RZ with axis=+Y
#   block3: RZ_GENERAL with origin=(0,0,1) and direction=(1,0,0)
#   block4: RZ_GENERAL with origin=(-1,-2,-3) and direction=(1,1,0)
#
...
[Mesh]
  ...
  coord_type = 'XYZ RZ RZ_GENERAL RZ_GENERAL'
  rz_coord_axis = Y

  rz_general_blocks = 'block3 block4'
  rz_general_origins = '0 0 1
                        -1 -2 -3'
  rz_general_directions = '1 0 0
                           1 1 0'
[]
